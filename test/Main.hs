...
coreLibs =
  [ CoreLibTest "git@github.com:alexmingoia/purescript-pux" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:bodil/purescript-smolder" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:bodil/purescript-signal" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:bodil/purescript-test-unit" [] ["Test.Main.main"] Nothing
  ...
  , CoreLibTest "git@github.com:purescript-contrib/purescript-argonaut-codecs" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-argonaut-core" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-argonaut-generic" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-argonaut-traversals" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-foreign-lens" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-handlebars" ["handlebars"] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-js-date" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-lens" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-profunctor-lenses" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-nullable" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-options" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-parsing" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-precise" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-string-parsers" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-strongcheck" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-unicode" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-js-timers" [] ["Test.Main.main"] Nothing
  , CoreLibTest "git@github.com:purescript-contrib/purescript-unsafe-reference" [] ["Test.Main.main"] Nothing
  ]
...
runZephyr
  ...
  -> [Text]
  -> ExceptT TestError IO ()
runZephyr coreLibTestRepo coreLibTestEntries = do
...
runTestLib (CoreLibTest {..}) = do
  ...
  runZephyr coreLibTestRepo coreLibTestEntries
...
runKarmaTest KarmaTest{..} = do
  ...
  runZephyr karmaTestRepo [karmaTestEntry]

  let main = T.intercalate "." . init . T.splitOn "." $ karmaTestEntry
...
contribSpec = do
  context "test libraries" $ 
    forM_ coreLibs $ \l@(CoreLibTest repo  _ _ _) ->
